...
| 10 | 1,2,16,22,81,82,96,102 |Сумма покупки в UI указана в рублях, в базе данных - в копейках | высокая |
| 11 | 83-95,97-101,103-115,17-119, 122-134,136-140,142-154,16,158 | При отправке запроса post на http://localhost:8080/api/v1/credit и http://localhost:8080/api/v1/pay при указании частично валидной карты приходит код ответа 200 | высокая|
| 12 | 36,76 | В приложении во вкладке elements отсутствует css-cелектор .notification_status_fail, при этом в styles он есть | низкая |
